function dateNow(){
    ...
    var formattedDateTime = dayOfWeek + ' ' + day + ' de ' + monthOfYear + ' de ' + year + ', ' + hours + ':' + minutes + ':' + seconds + ' ' + ampm;

    document.getElementById('dateNowBancolombia').innerHTML = formattedDateTime;
}
